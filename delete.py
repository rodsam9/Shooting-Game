...
class MenuView(arcade.View):
    ...
    def on_draw(self):
        arcade.start_render()
        arcade.draw_text("Germaphobe", WIDTH/2, HEIGHT/2,
...
class InstructionView(arcade.View):
    ...
    def on_draw(self):
        ...
        start_x = 210
        start_y = 400
        arcade.draw_text("INSTRUCTIONS", start_x, start_y, arcade.color.WHITE, 50)

        start_x = 210
        start_y = 280
        arcade.draw_text("Aim with your mouse and click to shoot your enemies", start_x, start_y, arcade.color.WHITE, 15)
        
        start_x = 170
        start_y = 220
        arcade.draw_text("Use the arrow keys on your keyboard to move around the screen", start_x, start_y, arcade.color.WHITE, 15)
...
class GameView(arcade.View):
    def __init__(self):
        ...
        self.instructions = []
        texture = arcade.load_texture("shooting_game/assets/background.jpg")
    ...
    def on_draw(self):
        ...
        self.player_list.draw(        self.coin_list.draw())
